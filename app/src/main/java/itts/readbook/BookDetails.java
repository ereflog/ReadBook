...
public class BookDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting the data which have passed from adapter class.
        ...
        //after getting the data then setting that data into text views and image view.
        ...
        //adding on click listener for preview button.
        previewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if the link is present then opening that link via an intent.
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if the link is present then open the link via an intent.
